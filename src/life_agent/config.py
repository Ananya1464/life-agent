...
DAILY_LOG_DATA_SOURCE_ID = os.getenv(
    "DAILY_LOG_DATA_SOURCE_ID", "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
)
# "Weight Loss Plan — 83 → 53 kg" page
WEIGHT_LOSS_PAGE_ID = os.getenv(
    "WEIGHT_LOSS_PAGE_ID", "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
)
# "Evening Check-in" database
EVENING_CHECKIN_DB_ID = os.getenv(
    "EVENING_CHECKIN_DB_ID", "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
)
...
LIFE_OS_METRICS_DB_ID = os.getenv(
    "LIFE_OS_METRICS_DB_ID", "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
)
# Life areas and goals database
LIFE_AREAS_GOALS_DB_ID = os.getenv(
    "LIFE_AREAS_GOALS_DB_ID", "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
)
# Main dashboard page
LIFE_OS_DASHBOARD_PAGE_ID = os.getenv(
    "LIFE_OS_DASHBOARD_PAGE_ID", "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
)
